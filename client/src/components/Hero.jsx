        ...
        <section className="hero" id="hero">
            ...
            <div className="container hero__content">
                ...
                >
                    ...
                    <h1 className="hero__name gradient-text">Anjisht Amritanshu</h1>
                    ...
                    <div className="hero__social">
                        ...
                        <a href="https://linkedin.com/in/anjisht-amritanshu-2b46b8285/" target="_blank" rel="noopener noreferrer" id="linkedin-link" aria-label="LinkedIn">
                            <svg viewBox="0 0 24 24" fill="currentColor" className="hero__social-icon">
